...
| [WINTER_DYNAMIC_REPLANNING_RC2_PARALLEL_RUN_REPORT.md](reports/research-validation/WINTER_DYNAMIC_REPLANNING_RC2_PARALLEL_RUN_REPORT.md) | Winter 真实动态回放、revision 生命周期与 C RC2 三核并行工程运行报告 |
