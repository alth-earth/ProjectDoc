...
| Replay-driven Viewer MVP（2026-08-19） | PASS（real artifact：GEBCO basemap + Simulation Clock + route/track/moving ship + deferred/pending semantics；L2 并入 preflight PASS；数据 proof PNG + bundle 单测；浏览器 smoke 待非受限环境执行） |
